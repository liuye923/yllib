...
def velovect(axes, x, y, u, v, linewidth=None, color=None,
               ...
               scale=1.0, grains=15, density=10, minlength=None):
    ...
    *scale* : float
    ...
    #yliu
#    minlength = minlength / magnitude_max
#    u = np.ma.masked_where(magnitude<minlength, u)
#    v = np.ma.masked_where(magnitude<minlength, v)
    ...
    for xs, ys in sp2:
        if not (grid.x_origin <= xs <= grid.x_origin + grid.width
            ...
            raise ValueError("Starting point ({}, {}) outside of data "
                             "boundaries\n".format(xs, ys)+
                             "grid_x={}, grid_y={}, grid_width={}, grid_height={}".format(grid.x_origin, grid.y_origin, grid.width, grid.height))
